...
export default function Items(){
    ...
    const items =  data?.map((item, index) =>{
        return  <section key={index+1} className="flex z-50 w-[313px] sm:px-[1.2rem] md:px-[unset] mx-auto flex-shrink-0 items-center content-between">
                    <section className="flex items-center mr-auto gap-[16px]">
                        <img 
