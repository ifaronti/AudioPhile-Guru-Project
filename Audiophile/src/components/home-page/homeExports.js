...
export const sectionItems = (category)=>{
    return  <div className="xl:w-[350px] cursor-pointer md:w-[223px] items-center content-center sm:w-[327px] xl:h-[284px] flex flex-col  relative sm:h-[217px]">
                ...
                <div className="sm:w-[327px] group text-black hover:text-[#D87D4A] peer/sect2 xl:w-[350px] md:pt-[116px] sm:pt-[88px] xl:pt-[116px] gap-[15px] md:w-[223px] absolute bottom-0 flex items-center content-center flex-col rounded-lg md:h-[204px] bg-[#f1f1f1] sm:h-[165px] ">
                    ...
                    <Link to={`/${category}`} className="flex items-center gap-[13.32px]">
