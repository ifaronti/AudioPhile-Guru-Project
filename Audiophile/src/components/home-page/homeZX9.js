...
export default function ZX9(){
    ...
    <motion.div role='presentation' initial={{ opacity: 0}} transition={{ duration: 1.8 }} whileInView={{ opacity: 1, scale:1 }} viewport={{ once: false}}>
        <section className="xl:w-[1110px] overflow-hidden sm:w-[327px] md:w-[689px] relative flex items-center content-center rounded-lg p-0 xl:h-[560px] md:h-[720px] h-[720px] sm:h-[600px] bg-[#D87D4A]">
            <div role='presentation' className="absolute xl:left-[-9rem] md:left-[-7rem] md:w-[900px] sm:left-[-8rem] sm:top-[-8rem] sm:w-[580px] md:top-[-16rem] xl:top-[-2rem] xl:w-[944px] z-[1] ">{patternImg}</div>
