...
import { productImg } from "./productExports";
    ...
    const product =
        <div className="relative">  
            <Link to={`/${data.category}`}>
                <button className="leading-[25px] sm:top-[-60px] absolute xl:top-[-95px] md:top-[-70px] xl:mb-[56px] sm:mb-[24px] font-Maronpe-Medium text-black opacity-50 text-left text-[15px]">Go Back</button>
            </Link> 
